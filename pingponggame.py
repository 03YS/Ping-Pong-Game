...
sketch.hideturtle()
sketch.goto(0, 260)
sketch.write("Player A: 0     Player B: 0",align="center", font=("Courier", 20, "normal"))
...
while True:
	...
	if hit_ball.xcor() > 500:
		...
		left_player += 1
		sketch.clear()
		sketch.write("Player A: {} Player B: {}".format(left_player, right_player), align="center",font=("Courier", 20, "normal"))
